...
parser.add_argument('--lr_rs', type=float, default=4e-5, help='learning rate of RS task')
parser.add_argument('--lr_kge', type=float, default=4e-6, help='learning rate of KGE task')
