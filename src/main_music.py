...
parser.add_argument('--dim', type=int, default=6, help='dimension of user and entity embeddings')
...
parser.add_argument('--lr_rs', type=float, default=1.2e-4, help='learning rate of RS task')
parser.add_argument('--lr_kge', type=float, default=6e-6, help='learning rate of KGE task')
