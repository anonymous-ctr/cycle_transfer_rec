...
parser.add_argument('--lr_rs', type=float, default=0.006, help='learning rate of RS task')
parser.add_argument('--lr_kge', type=float, default=0.003, help='learning rate of KGE task')
...
parser.add_argument('--seed', type=int, default=7, help='tensorflow random seed')

# book
# parser.add_argument('--dataset', type=str, default='book', help='which dataset to use')
# parser.add_argument('--n_epochs', type=int, default=20, help='the number of epochs')
# parser.add_argument('--dim', type=int, default=9, help='dimension of user and entity embeddings')
# parser.add_argument('--L', type=int, default=1, help='number of low layers')
# parser.add_argument('--H', type=int, default=1, help='number of high layers')
...
# parser.add_argument('--gpu_id', type=str, default='0', help='gpu id')
# parser.add_argument('--ndcg', type=bool, default=False, help='whether to print ndcg info')
# parser.add_argument('--seed', type=int, default=6, help='tensorflow random seed')  # 3/6/9
parser.add_argument('--debug', type=bool, default=True, help='tensorflow random seed')  # 3/6/9
...
parser.add_argument('--gpu_id', type=str, default='0', help='gpu id')
parser.add_argument('--ndcg', type=bool, default=False, help='whether to print ndcg info')
parser.add_argument('--seed', type=int, default=4, help='tensorflow random seed')
'''
